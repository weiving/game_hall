<template>
  ...
  <!--</div>-->
  <!--<iframe src="http://192.168.1.119:8000/#/hall/Hall" frameborder="0" width="100%" height="100%"></iframe>-->
  <!--<iframe src="/#/hall/Hall" frameborder="0" width="100%" height="100%" id="iframe"></iframe>-->
